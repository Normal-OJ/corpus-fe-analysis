    ...
    return {
      ...
      tableHeaders: [
        [
          ...
          {text: '語法指標類別',value: 'metricsCatalog',sortable: false},{text: '指標代碼',value: 'metricsId',sortable: false},{text: '指標',value: 'metrics',sortable: false},{text: '項目總分',value: 'itemScore'},{text: '類型總分',value: 'catalogScore'}
        ],
        [
          {
            text: 'Index  ',
    ...
    setTableDisplay(){
      ...
      switch(this.selectedDisplayMode){
        ...
        case '各指標總分':
          ...
          break
        case '所有加總分數':
          this.displayedItems = this.tableItems[0].slice(0,25)
          break
        default:
